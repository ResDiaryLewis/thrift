...
namespace Thrift.Transport.Client
{
    ...
    public class THttpTransport : TEndpointTransport
    {
        ...
        /// consumer can use the <c>CreateHttpMessageHandler</c> method to get a handler with these set.</remarks>
        ...
        /// <summary>
        /// Get a message handler configured with recommended properties to use with the <c>HttpClient</c> constructor
        /// and an <c>IHttpClientFactory</c>.
        /// </summary>
        /// <param name="certificates">An array of client certificates to associate with the handler.</param>
        /// <returns>
        /// A message handler with deflate and gZip compression-decompression algorithms and any client
        /// certificates passed in via <c>certificates</c>.
        /// </returns>
        public static HttpMessageHandler CreateHttpMessageHandler(X509Certificate[] certificates)
        {
        ...
        {
            var handler = CreateHttpMessageHandler(_certificates);
